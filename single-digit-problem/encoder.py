...
class EncoderBlock(nn.Module):
  def __init__(self, embed_dim, hidden_dim, num_heads):
    ...
    - Final feed-forward projects back to embed_dim (32)
    """
    ...
    # final linear layer after attention (24 -> 32), return back to embedding dimension
...
if __name__ == "__main__":
  ...
  print("Output shape:", output.shape) # (batch_size, n_patches, embed_dim) -> 32 x 16 x 32
